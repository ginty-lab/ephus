...
%
% SYNTAX
%  mapper_vividMap(powers, ISI, preDelay, postDelay)
...
function mapper_vividMap(powers, isi, preDelay, postDelay, varargin)
...
traceLength = preDelay + max(isi) * length(xCoords)+ postDelay;
