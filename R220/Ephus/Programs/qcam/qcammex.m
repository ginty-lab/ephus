...
%   'setTriggerType' <'edgeLow' | 'edgeHigh' | 'auto' | 'strobeHigh' | 'strobeLow' | 'pulseHigh' | 'pulseLow' > - Configure triggering. The 'auto' mode is intended for implementing a live preview.
%
...
%
% CHANGES
%  BS073113A & TO080813G - Add support for more triggerTypes.
%
