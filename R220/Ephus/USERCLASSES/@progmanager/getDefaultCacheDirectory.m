...
% VI070511A: Use pwd() in case where value is not a string (seems like BS032310A meant to do this); use faster 2-arg exist syntax
...
if isempty(value) || ~ischar(value) || ~exist(value,'dir') %VI070511A
    value = pwd;
end
