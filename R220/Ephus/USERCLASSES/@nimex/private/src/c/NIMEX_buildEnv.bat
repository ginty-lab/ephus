...
set NIMEX_ENV_MATLAB_PATH=C:\Program Files\MATLAB\R2007b
...
set NIMEX_ENV_ENGINE_TARGET_PATH=..\..\..\svobodalab\USERCLASSES\@nimexEngine\private
...
set NIMEX_ENV_MS_SDK=C:\Program Files\Microsoft Platform SDK for Windows Server 2003 R2
...
rem set NIMEX_ENV_COMPILER_ARGS=/O2 /fp:precise /c /nologo -DNIMEX_LOCALTIME_DEPRECATED -DNDEBUG -DMATLAB_MEX_FILE -DNIMEX_VERBOSE_0 -DNIMEX_COMPILER_CL
rem set NIMEX_ENV_COMPILER_ARGS_NON_MEX=/c /O2 /nologo -DNIMEX_LOCALTIME_DEPRECATED -DNIMEX_COMPILER_CL -DNIMEX_VERBOSE_0 -DNDEBUG
rem set NIMEX_ENV_COMPILER_ARGS_NON_MEX=/c /O2 /nologo -DNIMEX_LOCALTIME_DEPRECATED -DNIMEX_COMPILER_CL -DNIMEX_VERBOSE_0
set NIMEX_ENV_COMPILER_ARGS_NON_MEX=/arch:SSE2 /O2 /c /nologo -DNIMEX_LOCALTIME_DEPRECATED -DNIMEX_COMPILER_CL -DNIMEX_VERBOSE_0
...
rem set NIMEX_ENV_LIB_PATH=%NIMEX_ENV_MATLAB_PATH%\extern\lib\win32\microsoft
set NIMEX_ENV_LINKER_LIBS="%NIMEX_ENV_MATLAB_PATH%\extern\lib\win32\microsoft\libmx.lib" "%NIMEX_ENV_MATLAB_PATH%\extern\lib\win32\microsoft\libmex.lib" "%NIMEX_ENV_MATLAB_PATH%\extern\lib\win32\microsoft\libmat.lib" "%NIMEX_ENV_NI_PATH%\lib\msvc\NIDAQmx.lib" "%NIMEX_ENV_MS_SDK%\lib\uuid.lib" "%NIMEX_ENV_VS_HOME%\lib\libcmt.lib" "%NIMEX_ENV_MS_SDK%\lib\kernel32.lib" "%NIMEX_ENV_VS_HOME%\lib\oldnames.lib" "%NIMEX_ENV_GLIB_PATH%\lib\glib-2.0.lib" "%NIMEX_ENV_GLIB_PATH%\lib\gmodule-2.0.lib" "%NIMEX_ENV_GLIB_PATH%\lib\gobject-2.0.lib" "%NIMEX_ENV_GLIB_PATH%\lib\gthread-2.0.lib" "%NIMEX_ENV_MS_SDK%\lib\WinMM.lib" "%NIMEX_ENV_MS_SDK%\lib\User32.lib"
rem set NIMEX_ENV_LINKER_LIBS=/LIBPATH:"%NIMEX_ENV_MATLAB_PATH%\extern\lib\win32\microsoft\" /LIBPATH:%NIMEX_ENV_NI_PATH%\lib\msvc\ /LIBPATH:%NIMEX_ENV_MS_SDK%\lib\ /LIBPATH:%NIMEX_ENV_VS_HOME%\lib\ /LIBPATH:%NIMEX_ENV_GLIB_PATH%\lib\
rem set NIMEX_ENV_LINKER_LIBS=libmx.lib libmex.lib libmat.lib NIDAQmx.lib uuid.lib libcmt.lib kernel32.lib oldnames.lib glib-2.0.lib gmodule-2.0.lib gobject-2.0.lib gthread-2.0.lib WinMM.lib User32.lib
rem set NIMEX_ENV_LIB_PATH=/LIBPATH:"%NIMEX_ENV_MATLAB_PATH%\extern\lib\win32\microsoft\" /LIBPATH:%NIMEX_ENV_NI_PATH%\lib\msvc\ /LIBPATH:%NIMEX_ENV_MS_SDK%\lib\ /LIBPATH:%NIMEX_ENV_VS_HOME%\lib\ /LIBPATH:%NIMEX_ENV_GLIB_PATH%\lib\
