...
call NIMEX_compile.bat NIMEX_clearBuffer
call NIMEX_compile.bat NIMEX_isOutput
call NIMEX_compile.bat NIMEXEng_connectTerms
call NIMEX_compile.bat NIMEXEng_disconnectTerms
call NIMEX_compile.bat NIMEXEng_tristateOutputTerm
call NIMEX_compile.bat NIMEXEng_resetDevice
call NIMEX_compile.bat NIMEXEng_getDeviceNames
...
%NIMEX_ENV_LINKER% %NIMEX_ENV_LINKER_ARGS_NON_MEX% NIMEX_memManagement.obj NIMEX_utilities.obj NIMEX_genericStructures.obj NIMEX_Objects.obj NIMEX_Callbacks.obj %NIMEX_ENV_LINKER_LIBS% %NIMEX_ENV_LINKER_TARGET_PREFIX%NIMEX_shared.dll /DEF:NIMEX_shared.def
...
call NIMEX_link.bat NIMEX_clearBuffer
call NIMEX_link.bat NIMEX_isOutput
call NIMEX_link.bat NIMEXEng_connectTerms
call NIMEX_link.bat NIMEXEng_disconnectTerms
call NIMEX_link.bat NIMEXEng_tristateOutputTerm
call NIMEX_link.bat NIMEXEng_resetDevice
call NIMEX_link.bat NIMEXEng_getDeviceNames
...
echo Deploying to - %NIMEX_ENV_TARGET_PATH%
move NIMEX_*.mexw32 %NIMEX_ENV_TARGET_PATH%\.
move NIMEX_*.dll %NIMEX_ENV_TARGET_PATH%\.
move NIMEXEng_*.mexw32 %NIMEX_ENV_ENGINE_TARGET_PATH%\.
